...
object Player {
  def main(args: Array[String]) {
    ...
    val ghostGraph = GhostGraph(factoryCount, edges)
    val player = GhostCellPlayer(1)

    var factoryProd: Map[Int, Int] = Map.empty

    var turn = 1

    var bombObserved: Map[Int, Int] = Map.empty

    var bombBudget: Map[Int, Int] = Map(1 -> 2, -1 -> 2)
