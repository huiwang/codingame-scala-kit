...
object WondevBotDebug {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val updated = WarFogAnalysis.restrictOppoScope(observed, previousState, previousAction, previousOppoScope)

    val removed = WarFogAnalysis.removeFog(observed, updated)
